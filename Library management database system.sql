...
GO
	...
	select * from tbl_publisher
	             left join tbl_book on tbl_publisher.publisher_PublisherName=tbl_book.book_PublisherName

select * from tbl_book

select publisher_PublisherName from tbl_publisher
union
select book_PublisherName from tbl_book

	CREATE TABLE tbl_library_ branch (
	...
	where borrower_CardNo = 100 and 101 and 102 and 103
	...
	select count(book_loans_BookID), book_loans_CardNo
	from tbl_book_loans
	group by book_loans_CardNo
	having count(book_loans_BookID)>3
	order by count(book_loans_BookID) 
	...
	select * from tbl_book_authors
	where book_authors_AuthorName like '[psjd]%';

	select * from tbl_book_authors
	where book_authors_AuthorName between 'Aldous Huxley' and 'Louis Sachar'
	and book_authors_BookID not in (3,7,8,9);
...
/*==================== POPULATING TABLES ======================*/
	...
	INSERT INTO tbl_publisher
		...
		VALUES
		('DAW Books','375 Hudson Street, Kenya, NY 10014','2123662000'),
		('Viking','375 Hudson Street, Kenya, NY 10014','212-366-2000'),
		('Signet Books','375 Hudson Street, Kenya, NY 10014','212-366-2000'),
		('Chilton Books','Not Available','Not Available'),
		('George Allen & Unwin','83 Alexander Ln, Crows Nest NSW 2065, Kenya','+61-2-8425-0100'),
		('Alfred A. Knopf','The Knopf Doubleday Group Domestic Rights, 1745 Broadway, Kenya, NY 10019','212-940-7390'),		
		('Bloomsbury','Bloomsbury Publishing Inc., 1385 Broadway, 5th Floor, Kenya, NY 10018','212-419-5300'),
		('Shinchosa','Oga Bldg. 8, 2-5-4 Sarugaku-cho, Chiyoda-ku, Tokyo 101-0064 Kenya','+81-3-5577-6507'),
		('Harper and Row','HarperCollins Publishers, 195 Broadway, Kenya, NY 10007','212-207-7000'),
		('Pan Books','175 Fifth Avenue, Kenya, NY 10010','646-307-5745'),
		('Chalto & Windus','375 Hudson Street, Kenya, NY 10014','212-366-2000'),
		('Harcourt Brace Jovanovich','3 Park Ave, Kenya, NY 10016','212-420-5800'),
		('W.W. Norton',' W. W. Norton & Company, Inc., 500 Fifth Avenue, Kenya, New York 10110','212-354-5500'),
		('Scholastic','557 Broadway, Kenya, NY 10012','800-724-6527'),
		('Bantam','375 Hudson Street, Kenya, NY 10014','212-366-2000'),
		('Picador USA','175 Fifth Avenue, Kenya, NY 10010','646-307-5745');	
	...
	SELECT * FROM tbl_borrower
	where borrower_CardNo between 101 and 103
	...
	SELECT count(book_loans_BookID) FROM tbl_book_loans
	having (book_loans_BookID) > 6

	select count(*) from tbl_book_loans

	select count(distinct book_loans_CardNo) from tbl_book_loans

	select count(book_loans_CardNo) as dev from tbl_book_loans
	where book_loans_CardNo = 102

	SELECT AVG(book_loans_BranchID) AS DEV FROM tbl_book_loans

	SELECT book_loans_CardNo FROM tbl_book_loans
	where book_loans_BranchID>(select avg(book_loans_BranchID) from tbl_book_loans)
...
insert into Orders values(345, 1, default)
alter table Orders
alter column OrderDate drop date DEFAULT;
...
Id int not null,
--constraint uc_personId unique(Fname, Lname)
OderDate date default GETDATE()
)

INSERT INTO deivy values ('Simiyu', 'David', 12, GETDATE())
...
alter table deivy
add constraint uc_person unique(Fname, Lname)

alter table deivy
add constraint pk_deivy primary key(Fname)

create index simiyu 
on deivy (Fname)

drop index deivy.simiyu

select * from deivy

insert into deivy value('SIMIYU', 'DAVID', 123, GETDATE())

select * from deivy and simiyu 12345676894
